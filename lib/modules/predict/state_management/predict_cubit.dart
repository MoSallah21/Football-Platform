...
import 'package:football_platform/models/team_selection/team_seclection.dart';
...
class PredictCubit extends Cubit<PredictState> {
  PredictCubit() : super(AppInitState());
  static PredictCubit get(context) => BlocProvider.of(context);
  Future<Map<String, dynamic>> predictResults({
  ...
  TeamPredictModel model=TeamPredictModel
    (
      homeTeam: '',
      homeCode: 0,
      awayTeam: '',
  ...
  static const man_city = MenuItem(text: 'مانشستر سيتي', icon: Image(image: AssetImage('assets/images/clubs/manchester_city.png',),width: 60,height: 30,));
  static const liverpool =MenuItem(text: 'ليفربول', icon: Image(image: AssetImage('assets/images/clubs/liverpool_fc.png',),width: 60,height: 30,));
  static const arsenal =MenuItem(text: 'ارسنال', icon: Image(image: AssetImage('assets/images/clubs/arsenal_fc.png',),width: 60,height: 30,));
  static const man_united =MenuItem(text: 'مانشستر يونايتد', icon: Image(image: AssetImage('assets/images/clubs/manchester_united.png',),width: 60,height: 30,));
  static const tottenham =MenuItem(text: 'توتنهام', icon: Image(image: AssetImage('assets/images/clubs/tottenham_hotspur.png',),width: 60,height: 30,));
  static const chelsea =MenuItem(text: 'تشيلسي', icon: Image(image: AssetImage('assets/images/clubs/chelsea_fc.png',),width: 60,height: 30,));
  static const brighton =MenuItem(text: 'برايتون', icon: Image(image: AssetImage('assets/images/clubs/brighton.png',),width: 60,height: 30,));
  static const new_castle =MenuItem(text: 'نيوكاسل يونايتد', icon: Image(image: AssetImage('assets/images/clubs/new_castle.png',),width: 60,height: 30,));
  static const west_ham =MenuItem(text: 'ويست هام يونايتد', icon: Image(image: AssetImage('assets/images/clubs/west_ham_united.png',),width: 60,height: 30,));
  static const nottingham_forest =MenuItem(text: 'نوتينغهام فورست', icon: Image(image: AssetImage('assets/images/clubs/nottingham_forest.png',),width: 60,height: 30,));
  static const crystal_palace =MenuItem(text: 'كريستال بالاس', icon: Image(image: AssetImage('assets/images/clubs/crystal_palace.png',),width: 60,height: 30,));
  static const fulham =MenuItem(text: 'فولهام', icon: Image(image: AssetImage('assets/images/clubs/fulham.png',),width: 60,height: 30,));
  static const burnley =MenuItem(text: 'بيرنلي', icon: Image(image: AssetImage('assets/images/clubs/burnley.png',),width: 60,height: 30,));
  static const wolves =MenuItem(text: 'ولفرهامبتون', icon: Image(image: AssetImage('assets/images/clubs/wolverhampton_wanderers.png',),width: 60,height: 30,));
  static const brentford =MenuItem(text: 'برينتفورد', icon: Image(image: AssetImage('assets/images/clubs/brentford_fc.png',),width: 60,height: 30,));
  static const everton =MenuItem(text: 'ايفرتون', icon: Image(image: AssetImage('assets/images/clubs/everton.png',),width: 60,height: 30,));
  static const sheffield_united =MenuItem(text: 'شيفيليد يونايتد', icon: Image(image: AssetImage('assets/images/clubs/sheffield_united.png',),width: 60,height: 30,));
  static const bournemouth  =    MenuItem(text: 'بورنموث', icon: Image(image: AssetImage('assets/images/clubs/bournemouth_fc.png',),width: 60,height: 30,));
  static const aston_villa  =    MenuItem(text: 'استون فيلا', icon: Image(image: AssetImage('assets/images/clubs/aston_villa.png',),width: 60,height: 30,));
