...
class FinalPredictScreen extends StatefulWidget {
 ...
 final String awayChances;
  ...
  @override
  State<FinalPredictScreen> createState() => _FinalPredictScreenState();
}

late Size mediaSize;

class _FinalPredictScreenState extends State<FinalPredictScreen> {
              ...
              body: SingleChildScrollView(
                ...
                Column(
                  children: [
                    ...
                    child: Text('تعادل ',style: TextStyle(color: Colors.white,fontSize: 34,fontWeight: FontWeight.bold),)),
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text('الاستحواذ',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 14,
                                      shadows: [
                                        Shadow(
                                          color: Colors
                                              .purpleAccent.shade100,
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text('التسديدات',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 14,
                                      shadows: [
                                        Shadow(
                                          color: Colors
                                              .purpleAccent.shade100,
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text('التسديدات على المرمى',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 14,
                                      shadows: [
                                        Shadow(
                                          color: Colors
                                              .purpleAccent.shade100,
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text('الركنيات',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 14,
                                      shadows: [
                                        Shadow(
                                          color: Colors
                                              .purpleAccent.shade100,
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text('الفرص الخطيرة',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 14,
                                      shadows: [
                                        Shadow(
                                          color: Colors
                                              .purpleAccent.shade100,
                 ...
                 [
                   ...
                   AnimatedOpacity(
                     ...
                     child: Column(
                       children: [
                         Text('فوز',style: TextStyle(color: Colors.white,fontSize: 34,fontWeight: FontWeight.bold),),
                         widget.prediction==-1?
                         ...
                         Row(
                           ...
                           children: [
                             ...
                             Text('ضد',style: TextStyle(fontSize: 16,color: Colors.white,fontWeight: FontWeight.bold),),
