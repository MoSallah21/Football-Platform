...
import 'package:football_platform/modules/predict/predction_screen/shoots_screen.dart';
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text('ماهي نسبة الاستحواذ التي تتوقعها لكل من الفريقين ؟',style: TextStyle(fontSize: 16,color: Colors.white,fontWeight: FontWeight.w700,
                        shadows: [
                          Shadow(
                            color: Colors
                        ...
                        children: [
                          Column(
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsets.only(right:15.0),
                                child: Text('مضيف',style: TextStyle(color: Colors.white,shadows: [
                                  Shadow(
                                    color: Colors
                                        .purpleAccent.shade100,
                                    offset: Offset(1,
                          ...
                          Column(
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsets.only(right: 15.0),
                                child: Text('ضيف',style: TextStyle(color: Colors.white,shadows: [
                                  Shadow(
                                    color: Colors
                                        .purpleAccent.shade100,
                                    offset: Offset(1,
                    ...
                    CircularButton(onPressed: (){
                      if(homePosController.text ==''||awayPosController.text =='')
                      {
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                          content: Text('يرجى ادخال نسب استحواذ للفريقين للتوقع بلنتيجة بينهما'),
                      ...
                      {
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                          content: Text('نسبة الاستحواذ عالية جدا لاجد الفريقين ولايمكن ان يحدث هذا بلواقع'),
